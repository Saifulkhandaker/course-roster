const Cart = ({selectedCard, remainning, totalCost}) => {
    return (
        <div>
            <h1 className="w-full text-[#2F80ED] text-lg font-bold px-5 py-2">Credit Hour Remainning: {remainning} </h1>
            ...
            <h2 className="mt-2 font-semibold">Total Credit Hour: {totalCost} </h2>
